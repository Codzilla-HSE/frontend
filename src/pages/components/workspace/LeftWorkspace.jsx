...
import {multipartApi} from "../../../api/axiosConfig.js";
                            ...
                            <div className="toolbar-container">
                                <div className="toolbar">
                                    ...
                                    <input type="file" ref={fileInputRef} style={{display: 'none'}}
                                           onChange={handleFileImport} accept=".js,.py,.cpp,.txt"/>
                                    <button className="btn icon-btn" onClick={() => fileInputRef.current.click()}
                                            title="Загрузить из файла">
                                        <Import size={16}/>
                                    </button>
                                    <button className="btn icon-btn" onClick={toggleEditorFullscreen}
                                            title="Развернуть/свернуть окно">
                                        <Expand size={16}/>
                                    </button>
                                </div>
                            </div>
